...
import { ActivityIcon, LayoutDashboardIcon, WorkflowNavIcon, ArchitectureNavIcon, BookOpenIcon, SettingsIcon } from './icons'
...
const navItems = [
  ...
  { href: '/workflow-executions', label: 'Agent Runs', Icon: ActivityIcon },
